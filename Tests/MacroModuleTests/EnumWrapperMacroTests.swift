...
struct EnumWrapperMacroTests {
    ...
    /// The wrapper still generates but is not really usable.
    @Test
    func emptyEnum() {
        let input = """
            @EnumWrapper
        ...
        let expectedResult = """
            ...
            public struct EmptyEnumWrapper: Equatable, Hashable, Sendable {
                typealias WrappedValue = EmptyEnum
    ...
    func caseWithBackticksWrapAsExpected() {
        ...
        let expectedResult = """
            ...
            public struct SimpleEnumWrapper: Equatable, Hashable, Sendable {
                ...
                public static let `default` = Self.init(wrappedValue: .`default`)
    ...
    @Test
    func nestedInExtensionEnumWrapperAlsoNested() {
        let input = """
            public enum Namespace {}
